...
public class RegistrationFormTestProvider {
    ...
    public Iterator<Object[]> dpTestEmailValidation() {
        ...
        data.add(new Object[] {false, Messages.FIELD_REQUIRED, false, "'Електронна пошта' with empty field", ""});
        data.add(new Object[] {true, null, false, "'Електронна пошта' with spaces around", " test@gmail.com "});
        data.add(new Object[] {false, Messages.EMAIL_INVALID, false, "'Електронна пошта' with spaces", "tes t@gmail.com"});
    ...
    public Iterator<Object[]> dpTestUsernameValidation() {
        ...
        data.add(new Object[] {false, Messages.FIELD_REQUIRED, "User name empty", ""});
        ...
        data.add(new Object[] {false, Messages.USERNAME_INVALID, "Username with dot at the start", ".Ira"});
        data.add(new Object[] {false, Messages.USERNAME_INVALID, "Username with consecutive dots", "Ira..99"});
        data.add(new Object[] {false, Messages.USERNAME_INVALID, "Username too long", "IraThisUsernameIsWayTooLongForTheValidationRule"});
    ...
    public Iterator<Object[]> dpTestPasswordValidation() {
        ...
        data.add(new Object[] {false, Messages.PASSWORD_INVALID, "Password empty", ""});
        data.add(new Object[] {false, Messages.PASSWORD_INVALID, "Password too short", "Short1!"});
        data.add(new Object[] {false, Messages.PASSWORD_INVALID, "Password without uppercase", "password1!"});
        data.add(new Object[] {false, Messages.PASSWORD_INVALID, "Password without digit", "Password!@"});
        data.add(new Object[] {false, Messages.PASSWORD_INVALID, "Password without special char", "Password1a"});
        data.add(new Object[] {true, null, "Valid password", "Password1!"});
        data.add(new Object[] {false, Messages.PASSWORD_INVALID, "VeryLongPasswordThatExceeds20Chars1!", "Password1!Password1!Password1!"});
    ...
    public Iterator<Object[]> dpTestRepeatPasswordValidation() {
        ...
        data.add(new Object[] {false, Messages.FIELD_REQUIRED, "Confirm password empty", "Password1!", ""});
